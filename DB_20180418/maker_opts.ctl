...
genome=/scratch/group/digibio/s_cerevisiae/s_cerevisiae.dna.fa #genome sequence (fasta format or fasta embedded in GFF3)
...
est=/scratch/group/digibio/s_cerevisiae/s_cerevisiae.cds.fa #non-redundant set of assembled ESTs in fasta format (classic EST analysis) (comma separated list of files)
...
protein=/scratch/group/digibio/s_cerevisiae/s_cerevisiae.pep.fa #protein sequence file in fasta format
...
augustus_species=saccharomyces_cerevisiae_S288C      #Augustus gene prediction species model (see /software/easybuild/software/AUGUSTUS/3.1-intel-2015B-Python-3.4.3/config/species/)

fgenesh_par_file=               #Fgenesh parameter file

pred_gff=                       #ab-initio predictions from an external GFF3 file

model_gff=/scratch/group/digibio/s_cerevisiae/s_cerevisiae.gff3 #annotated gene models from an external GFF3 file (annotation pass-through)
