...
#BSUB -n 20                     # assigns 10 cores for execution
#BSUB -R "span[ptile=20]"       # assigns 10 cores per node
#BSUB -R "rusage[mem=2700]"     # reserves 200MB memory per core
#BSUB -M 2700                   # sets to 200MB per process enforceable memory limit. (M * n)
