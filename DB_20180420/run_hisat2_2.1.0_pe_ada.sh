...
#BSUB -o /scratch/user/tangxt/DBiology/DB1813_20180420.data/stdout.%J              # directs the job's standard output to stdout.jobid
#BSUB -e /scratch/user/tangxt/DBiology/DB1813_20180420.data/stderr.%J              # directs the job's standard error to stderr.jobid
...
pe_1='/scratch/user/tangxt/DBiology/DB1813_20180420.data/bigsby1_lane2.groomer.cutadapt.q30.artifacts.b15e1.l35.R1.fastq'
pe_2='/scratch/user/tangxt/DBiology/DB1813_20180420.data/bigsby1_lane2.groomer.cutadapt.q30.artifacts.b15e1.l35.R2.fastq'
...
output_bam="/scratch/user/tangxt/DBiology/DB1813_20180420.data/${sample}_pe_aln.bam"
################################################################################
