...
#BSUB -o /scratch/user/tangxt/DBiology/DB1813_20180420.data/stringtie.stdout.%J              # directs the job's standard output to stdout.jobid
#BSUB -e /scratch/user/tangxt/DBiology/DB1813_20180420.data/stringtie.stderr.%J              # directs the job's standard error to stderr.jobid
...
bam_file='/scratch/user/tangxt/DBiology/DB1813_20180420.data/bigsby1_lane2_pe_aln.bam'

label='bigsby1_lane2'
out_gtf="/scratch/user/tangxt/DBiology/DB1813_20180420.data/${label}_out.gtf"
