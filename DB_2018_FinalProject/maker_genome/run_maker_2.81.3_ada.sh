...
#BSUB -o /scratch/user/tangxt/DBiology/DB1813_FinalProject.data/maker_genome.data/stdout.%J              # directs the job's standard output to stdout.jobid
#BSUB -e /scratch/user/tangxt/DBiology/DB1813_FinalProject.data/maker_genome.data/stderr.%J              # directs the job's standard error to stderr.jobid
