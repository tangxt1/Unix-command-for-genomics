...
#BSUB -o /scratch/user/tangxt/DBiology/DB1813_FinalProject.data/stringtie.data/santana.stdout.%J              # directs the job's standard output to stdout.jobid
#BSUB -e /scratch/user/tangxt/DBiology/DB1813_FinalProject.data/stringtie.data/santana.stderr.%J              # directs the job's standard error to stderr.jobid
...
bam_file='/scratch/user/tangxt/DBiology/DB1813_FinalProject.data/Hisat.data/santana_pe_aln.bam'

label='santana'
out_gtf="/scratch/user/tangxt/DBiology/DB1813_FinalProject.data/stringtie.data/${label}_out.gtf"

################################################################################
#
stringtie $bam_file -G $annotation_file -e -l $label -o $out_gtf -p $threads
