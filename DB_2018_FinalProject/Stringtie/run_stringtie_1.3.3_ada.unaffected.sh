...
#BSUB -o /scratch/user/tangxt/DBiology/DB1813_FinalProject.data/stringtie.data/unaffected/merge.stdout.%J              # directs the job's standard output to stdout.jobid
#BSUB -e /scratch/user/tangxt/DBiology/DB1813_FinalProject.data/stringtie.data/unaffected/merge.stderr.%J              # directs the job's standard error to stderr.jobid
...
label='unaffected'
out_gtf="/scratch/user/tangxt/DBiology/DB1813_FinalProject.data/stringtie.data/unaffected/${label}_out.gtf"

################################################################################
#
stringtie --merge /scratch/user/tangxt/DBiology/DB1813_FinalProject.data/stringtie.data/unaffected/*gtf -G $annotation_file -e -l $label -o $out_gtf -p $threads
