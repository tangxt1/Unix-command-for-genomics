...
#BSUB -o /scratch/user/tangxt/DBiology/DB1813_FinalProject.data/stringtie.data/brach.stdout.%J              # directs the job's standard output to stdout.jobid
#BSUB -e /scratch/user/tangxt/DBiology/DB1813_FinalProject.data/stringtie.data/brach.stderr.%J              # directs the job's standard error to stderr.jobid
...
bam_file='/scratch/user/tangxt/DBiology/DB1813_FinalProject.data/Hisat.data/brach_pe_aln.bam'
