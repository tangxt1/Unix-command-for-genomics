...
est_gff=/scratch/user/tangxt/DBiology/DB1813_FinalProject.data/stringtie.data/bigsby_out.gff3,/scratch/user/tangxt/DBiology/DB1813_FinalProject.data/stringtie.data/xadius_out.gff3 #EST evidence from an external gff3 file(s) (comma separated list of files)
