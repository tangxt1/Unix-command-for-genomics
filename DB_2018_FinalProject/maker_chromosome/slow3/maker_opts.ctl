...
genome=/scratch/group/digibio/Canis-lupus-familiaris/zIndividualChromosomes/Canis_familiaris.CanFam3.1.dna.chromosome.22.fa #genome sequence (fasta format or fasta embedded in GFF3)
...
est=/scratch/group/digibio/Canis-lupus-familiaris/Canis_familiaris.CanFam3.1.cdna.all.fa #non-redundant set of assembled ESTs in fasta format (classic EST analysis) (comma separated list of files)

altest=                         #EST/cDNA sequence file in fasta format from an alternate organism

est_gff=/scratch/user/tangxt/DBiology/DB1813_FinalProject.data/stringtie.data/brach_out.gff3,/scratch/user/tangxt/DBiology/DB1813_FinalProject.data/stringtie.data/xellus_out.gff3,/scratch/user/tangxt/DBiology/DB1813_FinalProject.data/stringtie.data/zeus_out.gff3 #EST evidence from an external gff3 file(s) (comma separated list of files)

altest_gff=                     #Alternate organism EST evidence from a separate gff3 file

#-----Protein Homology Evidence (for best results provide a file for at least one)

protein=/scratch/group/digibio/Canis-lupus-familiaris/Canis_familiaris.CanFam3.1.pep.all.fa #protein sequence file in fasta format
...
augustus_species=human #Augustus gene prediction species model (see /software/easybuild/software/AUGUSTUS/3.1-intel-2015B-Python-3.4.3/config/species/)

fgenesh_par_file=               #Fgenesh parameter file

pred_gff=                       #ab-initio predictions from an external GFF3 file

model_gff=/scratch/group/digibio/Canis-lupus-familiaris/Canis_familiaris.CanFam3.1.92.gff3 #annotated gene models from an external GFF3 file (annotation pass-through)
