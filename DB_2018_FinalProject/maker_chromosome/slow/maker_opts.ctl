...
est=/scratch/group/digibio/Canis-lupus-familiaris/Canis_familiaris.CanFam3.1.cds.all.fa #non-redundant set of assembled ESTs in fasta format (classic EST analysis) (comma separated list of files)
