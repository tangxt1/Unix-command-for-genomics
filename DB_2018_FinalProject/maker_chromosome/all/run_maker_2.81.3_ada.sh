...
#BSUB -W 168:00                  # sets to 24 hour the job's runtime wall-clock limit.
#BSUB -o /scratch/user/tangxt/DBiology/DB1813_FinalProject.data/maker_chromosome.data/stdout.%J              # directs the job's standard output to stdout.jobid
#BSUB -e /scratch/user/tangxt/DBiology/DB1813_FinalProject.data/maker_chromosome.data/stderr.%J              # directs the job's standard error to stderr.jobid
