...
#BSUB -o /scratch/user/tangxt/DBiology/DB1813_FinalProject.data/xellus2.stdout.%J              # directs the job's standard output to stdout.jobid
#BSUB -e /scratch/user/tangxt/DBiology/DB1813_FinalProject.data/xellus2.stderr.%J              # directs the job's standard error to stderr.jobid
...
pe_1='/scratch/user/tangxt/DBiology/DB1813_FinalProject.data/Canis-lupus-familiaris.FinalProject.data/slow/xellus.R1.fastq'
pe_2='/scratch/user/tangxt/DBiology/DB1813_FinalProject.data/Canis-lupus-familiaris.FinalProject.data/slow/xellus.R2.fastq'
