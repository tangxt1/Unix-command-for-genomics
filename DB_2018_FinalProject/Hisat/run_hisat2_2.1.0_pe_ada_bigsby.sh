...
#BSUB -o /scratch/user/tangxt/DBiology/DB1813_FinalProject.data/bigsby.stdout.%J              # directs the job's standard output to stdout.jobid
#BSUB -e /scratch/user/tangxt/DBiology/DB1813_FinalProject.data/bigsby.stderr.%J              # directs the job's standard error to stderr.jobid
...
pe_1='/scratch/user/tangxt/DBiology/DB1813_FinalProject.data/Canis-lupus-familiaris.FinalProject.data/unaffected/bigsby.R1.fastq'
pe_2='/scratch/user/tangxt/DBiology/DB1813_FinalProject.data/Canis-lupus-familiaris.FinalProject.data/unaffected/bigsby.R2.fastq'
...
output_bam="/scratch/user/tangxt/DBiology/DB1813_FinalProject.data/${sample}_pe_aln.bam"
################################################################################
# If you will be using cufflinks downstream, run hisat2 with the --dta-cufflinks option instead of --dta
hisat2 --dta --tmo -p $threads --rg-id "$id" --rg "LB:$library" --rg "SM:$sample" --rg "PL:$platform" -x $genome_index_prefix -q -1 $pe_1 -2 $pe_2 -S out.sam
