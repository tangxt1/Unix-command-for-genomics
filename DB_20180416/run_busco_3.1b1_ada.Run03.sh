...
#BSUB -o /scratch/user/tangxt/DBiology/DB1813_20180416.data/BuscoRun03.stdout.%J              # directs the job's standard output to stdout.jobid
#BSUB -e /scratch/user/tangxt/DBiology/DB1813_20180416.data/BuscoRun03.stderr.%J              # directs the job's standard error to stderr.jobid
...
genome_file='/scratch/group/digibio/assemblies/DR34_pe_scaffolds.fasta'
...
output_prefix="/scratch/user/tangxt/DBiology/DB1813_20180416.data/out_busco_run03_${augustus_species}"
