...
#BSUB -o /scratch/user/tangxt/DBiology/DB1813_20180416.data/BuscoRun01.stdout.%J              # directs the job's standard output to stdout.jobid
#BSUB -e /scratch/user/tangxt/DBiology/DB1813_20180416.data/BuscoRun01.stderr.%J              # directs the job's standard error to stderr.jobid
...
output_prefix="/scratch/user/tangxt/DBiology/DB1813_20180416.data/out_busco_run01_${augustus_species}"
