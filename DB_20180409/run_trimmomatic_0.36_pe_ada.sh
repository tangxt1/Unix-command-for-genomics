...
#BSUB -o /scratch/user/tangxt/DB1813/DB_20180409.data/stdout.%J              # directs the job's standard output to stdout.jobid
#BSUB -e /scratch/user/tangxt/DB1813/DB_20180409.data/stderr.%J              # directs the job's standard error to stderr.jobid
...
################################################################################
#
outdir="/scratch/user/tangxt/DB1813/DB_20180409.data"

java -jar $EBROOTTRIMMOMATIC/trimmomatic-0.36.jar \
PE -threads $threads $quality_format $pe1_1 $pe1_2 \
    $outdir/${prefix}_pe1_trimmo.fastq.gz \
    $outdir/${prefix}_se1_trimmo.fastq.gz \
    $outdir/${prefix}_pe2_trimmo.fastq.gz \
    $outdir/${prefix}_se2_trimmo.fastq.gz \
