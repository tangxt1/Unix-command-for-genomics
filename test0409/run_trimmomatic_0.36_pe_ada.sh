...
#BSUB -o /scratch/user/tangxt/DBiology stdout.%J              # directs the job's standard output to stdout.jobid
#BSUB -e /scratch/user/tangxt/DBiology stderr.%J              # directs the job's standard error to stderr.jobid
...
################################################################################
#
outdir="/scratch/user/tangxt/DBiology"
...
PE -threads $threads $quality_format $pe1_1 $pe1_2 \
    ...
    $outfir/${prefix}_se2_trimmo.fastq.gz \
